/**
 * @file src/components/shared/icons/RefreshIcon.tsx
 * @purpose Refresh/reload icon for re-analyze action
 * @functionality
 * - Renders circular arrows SVG icon for refresh/reload
