  ...
  return (
    <section id="philosophy" className="py-28 bg-[var(--bg-secondary)]">
      <div className="max-w-[720px] mx-auto px-6 lg:px-10">
        ...
        {/* Title */}
        <h2 className="font-display text-[clamp(1.75rem,4vw,2.5rem)] font-medium leading-[1.3] mb-10 reveal">
          {t('philosophy.title')}
        </h2>

        {/* Problem Description */}
        <div className="text-[1.0625rem] text-[var(--text-secondary)] leading-[2] mb-10 space-y-6 reveal">
          <p>{t('philosophy.p1')}</p>
          <p>{t('philosophy.p2')}</p>
        </div>

        {/* Carl Rogers Quote */}
        <div className="pt-10 border-t border-[var(--border)] reveal">
