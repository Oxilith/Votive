 ...
 * @purpose Type definitions for the health check system
 * @functionality
 ...
 * - Defines HealthCheck interface for registerable health checks with runOnce support
 * @dependencies
...
export interface HealthCheck {
  ...
  critical: boolean;
  runOnce?: boolean; // If true, check runs at startup and result is cached
}
